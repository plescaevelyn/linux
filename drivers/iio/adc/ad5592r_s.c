...
static int iio_ad5592r_s_read_chan(struct iio_ad5592r_s_state *st,
...
static int ad5592r_s_spi_readback(struct iio_ad5592r_s_state *st, u8 reg,
				  u16 *readval)
{
	u16 tx = 0;
	u16 msg = 0;
