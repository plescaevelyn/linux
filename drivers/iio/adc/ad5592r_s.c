...
#define AD5582R_S_WR_VAL_MSK        GENMASK(8, 0)
			...
			long mask)
{
    ...
    case IIO_CHAN_INFO_RAW:
        if(st->en)
        {
            ...
            {
                case 0:
                    *val = st->chan0; return IIO_VAL_INT;
                case 1: 
                    *val = st->chan1; return IIO_VAL_INT;
                case 2:
                    *val = st->chan2; return IIO_VAL_INT;
                case 3: 
                    *val = st->chan3; return IIO_VAL_INT;
                case 4:
                    *val = st->chan4; return IIO_VAL_INT;
                case 5: 
                    *val = st->chan5; return IIO_VAL_INT;
                case 6:
                    *val = st->chan6; return IIO_VAL_INT;
                case 7: 
                    *val = st->chan7; return IIO_VAL_INT;
            }
        }
        else 
            return -EINVAL;
