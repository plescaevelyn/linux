			...
			long mask)
{
    ...
    case IIO_CHAN_INFO_RAW:
        ...
        case 1:
            ...
            return 0;
        case 2:
           st->chan2=val;// Example value for channel 2
            return 0;
        case 3:
           st->chan3=val; // Example value for channel 3
            return 0;
        case 4:
           st->chan4=val; // Example value for channel 4
            return 0;
        case 5:
            st->chan5=val; // Example value for channel 5
            return 0;
        default:
            return -EINVAL;
        }
        ...
        if(st->en){
            ...
            case 1:
                *val = st->chan1;
                return IIO_VAL_INT;
            case 2:
                *val = st->chan2; // Example value for channel 2
                return IIO_VAL_INT;
            case 3:
                *val = st->chan3; // Example value for channel 3
                return IIO_VAL_INT;
            case 4:
                *val = st->chan4; // Example value for channel 4
                return IIO_VAL_INT;
            case 5:
                *val = st->chan5; // Example value for channel 5
                return IIO_VAL_INT;
            default:
                return -EINVAL;
            }
